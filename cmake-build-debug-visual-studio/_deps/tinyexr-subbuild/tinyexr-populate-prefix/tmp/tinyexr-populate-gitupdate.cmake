...
execute_process(
  COMMAND "D:/Coding/Git/cmd/git.exe" --git-dir=.git show-ref "v1.0.7"
  WORKING_DIRECTORY "D:/Coding/C++_Projects/Capsaicin/third_party/gfx/third_party/tinyexr"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.0.7" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v1.0.7")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v1.0.7\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Coding/C++_Projects/Capsaicin/third_party/gfx/third_party/tinyexr'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Coding/C++_Projects/Capsaicin/third_party/gfx/third_party/tinyexr'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
